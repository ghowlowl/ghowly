...
HOOT_EGG_URL=https://github/url/to/download/rest/of/files

#Changes these to your own credentials
AWS_ACCESS_KEY_ID=AKIAJRX3QJDEN75JTCTA
AWS_SECRET_ACCESS_KEY=lwEMzOfbKE/55A6gX00DImpw5jDTOPo+7G8Qjv5Z
